...
{
    public abstract class MatoAppSampleWebTestBase : AbpAspNetCoreIntegratedTestBase<Startup>
    {
        protected static readonly Lazy<string> ContentRootFolder;

        static MatoAppSampleWebTestBase()
        {
        ...
        protected override IWebHostBuilder CreateWebHostBuilder()
        {
            return base
                ...
                .UseSetting(WebHostDefaults.ApplicationKey, typeof(MatoAppSampleWebMvcModule).Assembly.FullName);
        }
        ...
        {
            using (var context = IocManager.Resolve<MatoAppSampleDbContext>())
            {
                action(context);
                context.SaveChanges();
            }
        ...
        protected async Task UsingDbContextAsync(Func<MatoAppSampleDbContext, Task> action)
        {
            using (var context = IocManager.Resolve<MatoAppSampleDbContext>())
            {
        ...
        protected async Task<T> UsingDbContextAsync<T>(Func<MatoAppSampleDbContext, Task<T>> func)
        {
            T result;
